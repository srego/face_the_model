...
'''
### ACTRESSES ###
from check_upload import S3_Upload_Check

bucket = S3_Upload_Check('face-the-model-prototype',
                        'actresses',
                        '/Users/sergiorego/face_the_model_WIP/Tools/faceScrub/actresses/images')

bucket.upload_missing_local_to_S3()

df_common, uncommon_S3, uncommon_LD = bucket.compare_s3_and_local()
### ACTRESSES ###
...
bucket = S3_Upload_Check('face-the-model-prototype',
                        'actors',
                        '/Users/sergiorego/face_the_model_WIP/Tools/faceScrub/actors/images')
...
bucket = S3_Upload_Check('face-the-model-prototype',
                        'paul',
                        '/Users/sergiorego/face_the_model_WIP/Images/paul')
...
####
bucket.return_s3_folder_files()
bucket.return_local_folder_files()

bucket.return_s3_folder_files('paul')

check = S3_Upload_Check('face-the-model-prototype', ['/Users/sergiorego/Desktop/test_walk'])
check.return_local_folder_files()

'/Users/sergiorego/Desktop/test_walk'
'''